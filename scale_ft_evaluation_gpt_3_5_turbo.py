                ...
                try:
                    response = openai.ChatCompletion.create(
                        ...
                        messages=[
                            ...
                            {"role": "user", "content": f"Are the following pieces of code equivalent? \n {point}  \n These pieces of code"},
                        ],
                        temperature=0
                    )
                    ...
                    if 'no' in response_content or 'are not equivalent' in response_content:
                        prediction = 0
                    elif 'yes' in response_content or 'are equivalent' in response_content or 'are all equivalent' in response_content:
                        prediction = 1
                    else:
                        retries += 1
...
num_positives, len(preds), len(preds) - num_positives